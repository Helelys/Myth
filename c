...
export class SheetBuilderComponent implements OnInit {
  ...
  /** Collects all attributes from attribute_group fields across the sheet */
  ...
  saveAttrConfig() {
    ...
    // Build attributes list from names/values
  ...
  openSkillConfig(field: SheetField) {
    ...
    // Build skill columns from existing config
  ...
  saveSkillConfig() {
    ...
    // Reset value to match new columns
